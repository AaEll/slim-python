...
class SLIMCoefficientConstraints(object):
    ...
    def __init__(self, **kwargs):
        ...
        Args: kwargs (dictionary)
            - contains a (list?) variable_names
            - OR contains P (int) and x_1, x_2, ..., x_(P+1)
    ...
    def __str__(self):
        """
        Returns:
            str :  a pretty table of constraints on coefficients
        """
        x = PrettyTable()
        x.align = "r"
    ...
    def view(self):
        """
        Prints a pretty table of constraints on coefficients
        """
        print(self)
